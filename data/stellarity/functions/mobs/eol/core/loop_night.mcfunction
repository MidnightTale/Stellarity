...
data merge entity @s {CustomName:'{"translate":"stellarity.mobs.empress","fallback":"Empress of Light","color":"pink"}'}

bossbar set stellarity:eol color pink
bossbar set stellarity:eol name [{"translate":"stellarity.mobs.empress","fallback":"Empress of Light","color":"pink"}]
